...
This is just a fork of [lunamark](https://github.com/jgm/lunamark) version 0.5.0,
with two minor patches:

* underscores were removed from ephasis grammar definition
* generated html headers now have local hyperlinks, this makes markdown TOC work
